...
#
# This script has not been "genericized" or "parameterized", but doing this should be straightforward.
# TO DO: Parameterize script on 1 - input_raster_ds_path
#                               2 - working_gdb
#                               3 - final_output_fc
# 
# Author: Ben Krepp,  11/02/2022
...
# Load input raster
arcpy.MakeRasterLayer_management(in_raster=input_raster_ds_path, out_rasterlayer=input_raster_layer_name, 
where_clause="", envelope="221641.516430974 833090.936153378 281989.516430974 960748.936153378", band_index="1;1")
...
# Assemble string with semicolon-delimited list of input feature classes:
inputs_string = working_gdb + 'p_gt_10_pct_fc'
inputs_string += ';'
inputs_string += working_gdb + 'p_5_10_pct_fc'
inputs_string += ';'
inputs_string += working_gdb + 'p_2_5_pct_fc'
inputs_string += ';'
inputs_string += working_gdb + 'p_1_2_pct_fc'      
inputs_string += ';'
inputs_string += working_gdb +  'p_0d2_1_pct_fc'  
inputs_string += ';'
inputs_string += working_gdb + 'p_0d1_0d2_pct_fc'
inputs_string += ';'
inputs_string += working_gdb + 'p_lt_0d1_pct_fc'
# Perform the merge
arcpy.Merge_management(inputs=inputs_string, output=final_output_fc)
